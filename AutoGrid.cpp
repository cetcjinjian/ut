...
AutoGrid::AutoGrid(QWidget *parent) : FrameLessWnd(parent)
{
    initial();
}
...
void AutoGrid::setAtomGridHeight(double value)
{
    atomGridHeight = value;
}

void AutoGrid::setAtomGridWidth(double value)
{
    atomGridWidth = value;
}
