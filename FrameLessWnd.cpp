...
FrameLessWnd::FrameLessWnd(QWidget *parent) :QWidget(parent)
{
...
void FrameLessWnd::setBorder(int border)
{
	m_border = border;
}

void FrameLessWnd::mouseMoveRect(const QPoint& p)
{
...
void FrameLessWnd::mousePressEvent(QMouseEvent *event)
{
...
void FrameLessWnd::mouseMoveEvent(QMouseEvent *event)
{
...
void FrameLessWnd::mouseReleaseEvent(QMouseEvent *event)
{
	m_state.IsPressBorder = false;
	if (event->button() == Qt::LeftButton)
	{
